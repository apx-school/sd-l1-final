...
function ejecutarComando (params){
  ...
  if (params.title && params.id && params.tags) {
    return control.add(params).then((respuesta)=> {return respuesta})
  } else if (params.id){
    return control.get(params).then((respuesta)=> {return respuesta})
  } else if(params.search){
    return control.get(params).then((respuesta)=>{return respuesta})
  } else{
    return control.get({}).then((respuesta)=> {return respuesta})
  }
}

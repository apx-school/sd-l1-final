...
class PelisController {
  ...
  get = async (options: Options): Promise<Peli[]> => {
    ...
    if (typeof options.id === "number" && (typeof options.search.title === 'undefined' && typeof options.search.tags === 'undefined')) {
    ...
    if (( typeof options.search.tags === 'object' || typeof options.search.title === 'string') && (typeof options.id === 'undefined') ){
      ...
      const searchOptions = {
        ...
        tags: options.search.tags // Pasamos el array de tags
      };
